...
class SimpleSimulationHandler(ASimulationSystemHandler):
    ...
    def read_parameters_file(self, parameters_file_path) -> List[Parameter]:
        ...
        if hasattr(parameters_file_path, "read"):
            lines = parameters_file_path.read()
    ...
    def write_parameters_file(self, set_of_parameters: List[Parameter], location_to_store: str):
    ...
    def start_simulation(self, path_to_input_file: str):
